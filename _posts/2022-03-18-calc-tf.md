...
categories: SLAM
math: true
date: 2022-03-18 16:00
---
SLAM분야에서 두 프레임이 주어졌을때 transformation matrix를 구해야하는 상황이 흔히 발생한다.
...
![Untitled](/images/calc-tf/Untitled.png)

pitch : y축 기준 회전

![Untitled](/images/calc-tf/Untitled1.png)

yaw : z축 기준 회전 

![Untitled](/images/calc-tf/Untitled2.png)
...
![Untitled](/images/calc-tf/Untitled3.png)

IMU frame TF :

![Untitled](/images/calc-tf/Untitled 4.png)
...
- 위 계산법은 ZYX순서로 rotation을 계산하여야 한다.
